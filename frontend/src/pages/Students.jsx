...
export default function Students() {
    ...
    const initialFormState = {
        ...
        email: '', phone: '', placement_course_id: '' 
    };
        ...
        <Box sx={{ pb: 5 }}>
            ...
            >
                <Box sx={{ width: { xs: '100vw', sm: 450 }, p: 4, height: '100%', overflowY: 'auto' }}>
                    ...
                    <Grid container spacing={2.5} mb={4}>
                        ...
                        <Grid xs={12}>
                            <TextField fullWidth label="Institutional Code (Optional)" name="student_code" value={formData.student_code} onChange={handleInputChange} size="small" 
                                ...
                                slotProps={{ inputLabel: !editingId ? { shrink: true } : {} }}
                            />
                        </Grid>
                    </Grid>
                    <Divider sx={{ mb: 3 }} />
                    ...
                    {/* Block 4: Academic Status  */}
                    {!editingId && (
                        <>
                            <Typography variant="subtitle2" color="primary" mb={2}>Academic Status</Typography>
                            <Grid container spacing={2.5} mb={5}>
                                <Grid xs={12}>
                                    <TextField 
                                        select 
                                        fullWidth 
                                        label="Placement Test Approved Course" 
                                        name="placement_course_id" 
                                        value={formData.placement_course_id} 
                                        onChange={handleInputChange} 
                                        size="small"
                                        helperText="Select ONLY if the student took a placement test. (e.g. If they passed Basic 5, select Basic 5 here so they can enroll in Basic 6)."
                                    >
                                        <MenuItem value=""><em>None (Starts from the beginning)</em></MenuItem>
                                        {courses.map(c => (
